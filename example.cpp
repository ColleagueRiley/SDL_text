...
int main(){
    ...
    if(!text.init()){text.TextGetError();}if(!text2.init()){text2.TextGetError();}if(!text3.init()){text3.TextGetError();}if(!text4.init()){text4.TextGetError();}
    ...
    while (running){
        ...
        if(!text2.draw(renderer)){text2.TextGetError();}
        if(!text3.draw(renderer)){text3.TextGetError();}
        if(!text4.draw(renderer)){text4.TextGetError();}
